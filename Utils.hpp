...
public:
				...
				static void PrintTime(chrono::steady_clock::time_point start, chrono::steady_clock::time_point end)
				{
								chrono::duration<double> elapsedSeconds = end - start;
								cout << fixed << "Elapsed time: " << elapsedSeconds.count() * 1000 << " milliseconds\n";
				}
